...
function SimpleDialog(props) {
  ...
  return (
    <Dialog onClose={handleClose} aria-labelledby="simple-dialog-title" open={open}>
       <Sectitle sClass=" text-center " TitleP='Dashboard | Qognition'/>
...
export default function Dialoghome() {
  ...
  return (
    <div>
      <Reveal effect="fadeInLeft" duration={1200}><div className="wow fadeInRight" onClick={handleClickOpen}>Dashboard</div></Reveal>
